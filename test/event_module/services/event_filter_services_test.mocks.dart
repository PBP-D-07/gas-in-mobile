...
// in gas_in/test/event_module/services/event_filter_services_test.dart.
...
class MockCookieRequest extends _i1.Mock implements _i3.CookieRequest {
  ...
  @override
  set cookies(Map<String, _i3.Cookie>? _cookies) => super.noSuchMethod(
    Invocation.setter(#cookies, _cookies),
    returnValueForMissingStub: null,
  );

  @override
  set jsonData(Map<String, dynamic>? _jsonData) => super.noSuchMethod(
    Invocation.setter(#jsonData, _jsonData),
    returnValueForMissingStub: null,
  );

  @override
  set local(_i2.SharedPreferences? _local) => super.noSuchMethod(
    Invocation.setter(#local, _local),
    returnValueForMissingStub: null,
  );
